...
class _CameraScreenState extends State<CameraScreen> {
  ...
  Future<void> takePicture() async {
    ...
    if (photo != null) {
      ...
      print(
          "✅ Base64 이미지: ${base64String.substring(0, 100)}..."); // 긴 Base64는 일부만 출력
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("카메라로 사진 찍고 Base64 변환")),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            _imageFile != null ? Image.file(_imageFile!) : Text("아직 사진 없음"),
            SizedBox(height: 20),
            ElevatedButton(
